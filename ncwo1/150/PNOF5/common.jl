...
data_150 = YAML.load_file("AllElements_150.yaml")
...
mols_new = setdiff(mols_150, mols_150_in_100, mols_150_in_50, mols_150_in_30)

println("Repeated with 030:")
s = ""
for molecule_name in mols_150_in_30
    global s = s* string(molecule_name) * ".jl "
end
println(s)
println("Repeated with 050:")
s = ""
for molecule_name in mols_150_in_50
    global s = s* string(molecule_name) * ".jl "
end
println(s)
println("Repeated with 100:")
s = ""
for molecule_name in mols_150_in_100
    global s = s* string(molecule_name) * ".jl "
end
println(s)
